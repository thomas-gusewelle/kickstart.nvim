...
vim.keymap.set('n', '<S-l>', '<cmd>BufferLineCycleNext<cr>', {desc = "Previous Buffer", silent  =true})
...
vim.keymap.set('n', '<leader>t', '<cmd>lua require("FTerm").toggle()<cr>', {silent = true, desc = "Find Todos"} )
